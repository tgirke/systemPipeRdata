...
##                         grl=feat, singleEnd=TRUE, readlength=NULL,
##                         type="data.frame")
...
## multicoreParam <- MulticoreParam(workers=8); register(multicoreParam)
## registered()
...
## go <- getBM(attributes=c("go_accession", "tair_locus", "go_namespace_1003"),
##             mart=m)
