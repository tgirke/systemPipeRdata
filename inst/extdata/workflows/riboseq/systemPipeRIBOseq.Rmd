...
package: systemPipeR
vignette: |
  %\VignetteIndexEntry{RIBO-Seq Workflow}
...
![](fastqReport.png)
<div align="center"><b>Figure 2:</b> FASTQ quality report. To zoom in, rigth click image and open it in a separate browser tab. </div></br>
