...
```{r fastq_report, eval=TRUE, message=FALSE, spr='r', spr.dep='trimming'}
...
`{r bam_urls, eval=FALSE, spr='r', spr.dep='hisat2_mapping'}` if this step is needed. 
...
```{r sessionInfo, spr='r', spr.dep='heatmap'}
sessionInfo()
```
