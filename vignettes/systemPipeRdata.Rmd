...
To access individual components of the sample data provided by _`systemPipeRdata`_, one can return the paths to their individual components as a _`list`_.
