...
Note: the most recent version of this tutorial can be found <a href="https://htmlpreview.github.io/?https://github.com/tgirke/systemPipeR/blob/master/vignettes/systemPipeR.html">here</a>.

# Introduction

This package provides sample data for running the NGS workflows of the _`systemPipeR`_ package [@Girke2014-oy]. The source and usage of the data is described in the overview vignette [here](http://www.bioconductor.org/packages/devel/bioc/html/systemPipeR.html).
