...
download.file("https://raw.githubusercontent.com/tgirke/systemPipeRdata/master/vignettes/systemPipeRIBOseq.Rmd", "systemPipeRIBOseq2.Rmd")
```
...
writeTargetsout(x=trim, file="targets_trim.txt", overwrite=TRUE)
```
...
outpaths <- subsetWF(args , slot="output", subset=1)
