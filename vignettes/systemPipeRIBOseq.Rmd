...
Rscript -e "rmarkdown::render('systemPipeRIBOseq.Rmd', c('BiocStyle::html_document'), clean=F); knitr::knit('systemPipeRIBOseq.Rmd', tangle=TRUE)"; Rscript -e "rmarkdown::render('systemPipeRIBOseq.Rmd', c('BiocStyle::pdf_document'))"
-->
...
```{r sample_tree, eval=FALSE, eval=TRUE, , spr=TRUE}
appendStep(sal) <- LineWise(
    code = {
