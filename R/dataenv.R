...
#########################################
genWorkenvir <- function(workflow, mydirname=NULL, bam=FALSE, url=NULL, urlname=NULL) {
    ...
    if(workflow=="varseq") {
        ...
        file.copy(c("varseq/param/bibtex.bib"), "./varseq/bibtex.bib", overwrite=TRUE)
        ...
        file.copy(c("rnaseq/param/bibtex.bib"), "./rnaseq/bibtex.bib", overwrite=TRUE)
        ...
        file.copy(c("riboseq/param/bibtex.bib"), "./riboseq/bibtex.bib", overwrite=TRUE)
        ...
        file.copy(c("chipseq/param/bibtex.bib"), "./chipseq/bibtex.bib", overwrite=TRUE)
    } else {
