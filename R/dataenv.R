...
genWorkenvir <- function(workflow, mydirname=NULL, bam=FALSE) {
    ...
    if(workflow=="varseq") {
        ...
        file.copy(c("varseq/param/slurm.tmpl", "varseq/param/.BatchJobs.R"), "./varseq")
        ...
        file.copy(c("rnaseq/param/slurm.tmpl", "rnaseq/param/.BatchJobs.R"), "./rnaseq")
        ...
        file.copy(c("riboseq/param/slurm.tmpl", "riboseq/param/.BatchJobs.R"), "./riboseq")
        ...
        file.copy(c("chipseq/param/slurm.tmpl", "chipseq/param/.BatchJobs.R"), "./chipseq")
